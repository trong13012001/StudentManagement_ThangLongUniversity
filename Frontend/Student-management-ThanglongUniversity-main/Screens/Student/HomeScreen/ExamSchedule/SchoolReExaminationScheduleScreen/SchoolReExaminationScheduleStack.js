...
const SchoolReExaminationScheduleStack = () => {
  return (
    <Stack.Navigator initialRouteName="Danh sách thi từng học kỳ">
      <Stack.Screen name="Danh sách thi từng học kỳ" component={SchoolReExaminationScheduleTerm} options={{ headerShown: false }} />
      <Stack.Screen name='Danh sách môn thi' component={SchoolReExaminationScheduleScreen} options={{headerShown: false, unmountOnBlur: true}}/>
    </Stack.Navigator>
  )
}
