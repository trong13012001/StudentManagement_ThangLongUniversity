...
const StudentHomeScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity onPress={item.onPress} key={item.key}>
    ...
    <>
      ...
      <View style={{ marginLeft: "5%", top: "10%" }}>
        ...
        <Text allowFontScaling={false} style={styles.header3}>
          <Text style={{ textTransform: "uppercase" }}>{user_id} </Text>
          {userName}
        </Text>
      </View>
        ...
        <FlatList
          data={[
...

            {
              ...
              icon: "school",
              onPress: () => {
                navigation.navigate("Chương trình đào tạo", { dataUser });
              },
            },
          ]}
          ...
          data={[
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Đăng ký học" })
                );
              },
            },
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Đăng ký thi lại" })
                );
              },
            },

            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Phiếu báo thu tiền Stack" })
                );
              },
            },
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Bảng điểm" })
                );
              },
            },
            {
            ...
            },
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Phiếu báo điểm" })
                );
              },
            },
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Lịch ký sổ gốc" })
                );
              },
            },
            {
              ...
              onPress: () => {
                navigation.dispatch(
                  CommonActions.navigate({ name: "Định hướng học tập" })
                );
              },
            },
          ]}
