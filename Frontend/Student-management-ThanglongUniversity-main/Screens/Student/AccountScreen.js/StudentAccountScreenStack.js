...
const StudentAccountScreenStack = () => {
  return (
    <Stack.Navigator initialRouteName="Thông tin">
      <Stack.Screen name="Thông tin" component={StudentAccountScreen} options={{ headerShown: false }} />
      <Stack.Screen name='Thông tin sinh viên' component={InformationScreen} options={{headerShown: false, unmountOnBlur: true}}/>
