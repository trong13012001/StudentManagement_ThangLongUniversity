...
const StudentAccountScreen = ({ navigation }) => {
  ...
  const handleLogout = async () => {
    Alert.alert("Đăng xuất", "Bạn có chắc bạn muốn đăng xuất?", [
      {
        text: "Quay lại",
      },
      {
      ...
      <View style={styles.itemwrapper}>
        <View style={[styles.item]}>
          ...
          <Text
            ...
            style={{ paddingLeft: "2.79%", fontSize: 16, paddingTop: "0.5%" }}
          >
            {item.title}
          </Text>
          {item.title === "Đăng xuất" ||
          item.title === "Xóa tài khoản" ? null : (
            <Icon1
        ...
        <ScrollView>
          ...
          >
            ...
            <Text
              ...
              style={[
                styles.text,
                { color: GlobalStyle.textColor.color, fontSize: 14 },
              ]}
            >
              {emailStudent}
            </Text>
                  ...
                  onPress: () => {
                    navigation.dispatch(
                      CommonActions.navigate({
                        name: "Tài khoản",
                        params: { screen: "Thông tin sinh viên" },
                      })
                    );
                  },
                },
